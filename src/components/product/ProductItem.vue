  ...
  <div class="thumbnail ">
    ...
    <div class="ratings margin-left-sm">
      ...
      <p style="width:100%;display:flex;flex-direction:row">
        <button class="btn btn-success" style="width:35%" :disabled="item.quantity === 0" @click="addItem">
                        Add to cart
                    </button>
                    
        <button class="btn btn-success" style="width:35%;margin-left:30%" :disabled="item.quantity === 0" @click="addItem">
            Details
        </button>
      </p>
